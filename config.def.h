...
static const char col_pink[]	    = "#ff33ff";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_pink, "-sf", col_gray4, "-h", "30", "-g", "3", "-l", "5", NULL };
